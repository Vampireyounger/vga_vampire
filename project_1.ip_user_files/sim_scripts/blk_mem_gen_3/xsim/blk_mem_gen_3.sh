...
#
# Generated by Vivado on Tue Nov 14 20:54:43 +0800 2023
...
xv_boost_lib_path=C:/Vivodo/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="C:/Vivodo/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
